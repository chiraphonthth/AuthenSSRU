...
//  AuthenSSRU
//
//  Created by Student02 on 20/3/2562 BE.
...
class RegisterViewController: UIViewController {
    ...
    func uploadData(name:String,user:String,password:String) -> Void {
        ...
        let urlString :String  =  "https://www.androidthai.in.th/snru/addDataChiraphon.php?isAdd=true&Name=\(name)&User=\(user)&Password=\(password)"
